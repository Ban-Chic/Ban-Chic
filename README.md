...
## 서비스 소개
- 향수를 사용하는 누구나 본인이 좋아하는 향의 향수를 찾습니다.
세상에는 수 십만 가지의 향수가 존재하지만 유명 브랜드의 향수정도만 알고 있는게 현실입니다.
사용자가 좋아할만한 향으로 이루어진 향수 추천 목록을 제시하는 서비스 Ban:chic 입니다.
...
<table>
  ...
  <tr>
    ...
    <td align="center"><b>BE, INFRA</b></td>
    <td align="center"><b>BE, AI, INFRA</b></td>
  </tr>
</table>
